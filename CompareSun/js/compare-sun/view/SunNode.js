 ...
 */
 ...
 import { DragListener, Image, Node, Text } from '../../../../scenery/js/imports.js';
 ...
 class BarMagnetNode extends Node {
   ...
   constructor( barMagnet, modelViewTransform ) {
     ...
     // Move the magnet by dragging it. // controller
 ...
 // controller 
     ...
     this.addChild( new Text( 'Sun' ), { setFontSize: 500, centerX: 128, centerY: 32 } );
